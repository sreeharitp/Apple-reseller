...
const Card2 = ({ title, price, url, img }) => {
  return (
    <div className="w-full h-full bg-[#000000] rounded-2xl px-6 pt-6 flex flex-col justify-between group overflow-hidden">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-white text-[18px] font-medium">{title}</h3>
          <p className="text-[#CDD1D7] text-[14px] font-light">{price}</p>
        </div>
        <Link to={url}>
